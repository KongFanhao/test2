...
public class LoginTest {
	...
	public void test1() throws Exception {
		...
		HttpPost httppost = new HttpPost(
				"http://211.81.31.34/uhtbin/cgisirsi/x/0/0/57/49?user_id=LIBSCI_ENGI&password=LIBSC");

		System.out.println("请求: " + httppost.getRequestLine());
		// 构造最简单的字符串数据
		StringEntity reqEntity = new StringEntity("username=R0500A20135916&password=000");
		// 设置类型
	...
	private void opera() throws Exception {
		...
		String logPath = "http://211.81.31.34/uhtbin/cgisirsi/x/0/0/57/49?user_id=LIBSCI_ENGI&password=LIBSC";
